...
public class YugabyteSpringApplication implements CommandLineRunner {
	...
	public void getItemsByCategory(String category) {
		...
		List<GroceryItem> list = groceryItemRepo.findItemsByCategory(category);
	...
	public void updateCategoryName(String category) {
		...
		if(itemsUpdated != null)
			System.out.println("Successfully updated " + itemsUpdated.size() + " items from " + category + " to " + newCategory);
	}
	...
	public void updateItemQuantity(String name, int newQuantity) {
		...
		groceryItemRepo.updateItemQuantity(name, newQuantity);
	}
